...
pcs resource create openstack-nova-cert systemd:openstack-nova-cert meta interleave=true op monitor interval=60s start interval=0s timeout=200s stop interval=0s timeout=200s --clone
