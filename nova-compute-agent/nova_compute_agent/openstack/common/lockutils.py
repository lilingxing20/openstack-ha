...
from nova_compute_agent.openstack.common import fileutils
...
util_opts = [
 ...
 cfg.StrOpt('lock_path', default=os.environ.get('NOVA_LOCK_PATH'), help='Directory to use for lock files.')]
CONF = cfg.CONF
...
def synchronized_with_prefix(lock_file_prefix):
    ...
    Redefine @synchronized in each project like so::
        ...
        (in nova_compute_agent/utils.py)
        from nova_compute_agent.openstack.common import lockutils
    
        synchronized = lockutils.synchronized_with_prefix('nova_compute_agent-')
    
    
        (in nova_compute_agent/foo.py)
