...
eventlet_backdoor_opts = [
 cfg.StrOpt('backdoor_port', default=None, help='Enable eventlet backdoor. %s' % help_for_backdoor_port)]
CONF = cfg.CONF
...
class EventletBackdoorConfigValueError(Exception):
    ...
    def __init__(self, port_range, help_msg, ex):
        msg = 'Invalid backdoor_port configuration %(range)s: %(ex)s. %(help)s' % {'range': port_range,'ex': ex,'help': help_msg}
...
def _parse_port_range(port_range):
    ...
    try:
        ...
        raise EventletBackdoorConfigValueError(port_range, ex, help_for_backdoor_port)
