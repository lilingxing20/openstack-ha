...
openstack-config --set /etc/heat/heat.conf DEFAULT heat_metadata_server_url http://control_vip:8000
openstack-config --set /etc/heat/heat.conf DEFAULT heat_waitcondition_server_url http://control_vip:8000/v1/waitcondition
openstack-config --set /etc/heat/heat.conf DEFAULT heat_watch_server_url http://control_vip:8003
...
## clients_keystone
openstack-config --set /etc/heat/heat.conf clients_keystone auth_uri http://control_vip:35357
## database
openstack-config --set /etc/heat/heat.conf database connection mysql+pymysql://heat:teamsun@control_vip/heat
## ec2authtoken
openstack-config --set /etc/heat/heat.conf ec2authtoken auth_uri http://control_vip:5000/v2.0
## heat_api
...
## authtoken
openstack-config --set /etc/heat/heat.conf keystone_authtoken auth_uri http://control_vip:5000/v2.0
openstack-config --set /etc/heat/heat.conf keystone_authtoken identity_uri http://control_vip:35357
...
openstack-config --set /etc/heat/heat.conf oslo_messaging_rabbit rabbit_hosts controller1-internalapi,controller2-internalapi,controller3-internalapi
...
openstack-config --set /etc/heat/heat.conf trustee auth_url http://control_vip:35357
